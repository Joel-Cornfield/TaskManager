...
const Navbar = () => {
    ...
    const { workspaces, user, token } = state;
    const [showWorkspaceDropdown, setShowWorkspaceDropdown] = useState(false);
    const [showModal, setShowModal] = useState(false);
    const [modalType, setModalType] = useState('') // 'task' or 'workspace'
        ...
        <>
            <nav className="navbar">
                <div className="navbar-left">
                    ...
                    <div className="workspace-section" ref={dropdownRef}>
                        <button 
                    ...
                    <button className='create-btn' onClick={() => setShowCreateMenu(!showCreateMenu)}>
                        + Create
